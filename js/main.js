...
const SPEC_1 = {
  ...
  title: {
    text: "Population Growth in Malaysia (2000-2024)",
    subtitle: "Total population, measured in millions of people",
    anchor: "start"
  },
...
const SPEC_2 = {
  ...
  title: {
    text: "Annual Population Growth Rate (2000-2024)",
    subtitle: "Annual percentage change in total population",
    anchor: "start"
  },
...
const SPEC_3 = {
  ...
  title: {
    text: "Population by Age Group (2024)",
...
const SPEC_4 = {
  ...
  spacing: 0,
  title: {
    text: "Population Pyramid of Malaysia (2024)",
    subtitle: "Population by age group and sex, measured in millions",
    anchor: "start"
  },
...
const SPEC_5 = {
  ...
  title: {
    text: "Male and Female Population Share (2000-2024)",
    subtitle: "Share of total population by sex",
    anchor: "start"
  },
...
const SPEC_6 = {
  ...
  title: {
    ...
    subtitle: "State and federal territory population, measured in millions",
    anchor: "start"
  },
  ...
  encoding: {
    ...
    tooltip: [
      ...
      { field: "population_million", type: "quantitative", title: "Population (Million)", format: ".2f" },
...
const SPEC_7 = {
  ...
  title: {
    text: "Top 5 Most Populated States (2024)",
    subtitle: "Largest state populations, measured in millions",
    anchor: "start"
  },
...
const SPEC_8 = {
  ...
  title: {
    text: "Urban and Rural Population Share (2000-2024)",
    subtitle: "Urban share rises while rural share declines",
    anchor: "start"
  },
...
const SPEC_9 = {
  ...
  title: {
    text: "Life Expectancy in Malaysia (2000-2024)",
    subtitle: "Life expectancy at birth, total population",
    anchor: "start"
  },
...
const SPEC_10 = {
  ...
  title: {
    text: "Age Dependency Ratio in Malaysia (2000-2024)",
    subtitle: "Dependents as a share of the working-age population",
    anchor: "start"
  },
  encoding: {
    x: X_YEAR,
...
/* ============================================================
   Chart 11 — Demographic Pressure Index
   Custom derived indicator, 2024
   ============================================================ */
...
const PRESSURE_INDEX_DATA = [
  {
    metric: "Ageing share",
    raw_label: "65+ share: 7.7%",
    score: 38.5
  },
  {
    metric: "Dependency ratio",
    raw_label: "41.9 dependents per 100 working-age people",
    score: 41.9
  },
  {
    metric: "Urban share",
    raw_label: "Urban share: 76.9%",
    score: 76.9
  },
  {
    metric: "Population concentration",
    raw_label: "Top 5 states: 59.8%",
    score: 59.8
  }
];
...
const SPEC_11 = {
  ...
  height: 300,
  data: {
    values: PRESSURE_INDEX_DATA
  },
  title: {
    text: "Demographic Pressure Index (2024)",
    subtitle: "Custom score from ageing, dependency, urbanisation and concentration",
    anchor: "start"
  },
  layer: [
    {
    ...
    },
    {
      ...
      encoding: {
        ...
        tooltip: [
          ...
          { field: "raw_label", type: "nominal", title: "Raw value" },
          { field: "score", type: "quantitative", title: "Pressure score", format: ".1f" }
        ]
      }
    },
    {
      transform: [
        {
          calculate: "format(datum.score, '.1f') + '/100'",
          as: "score_label"
        }
      ],
      mark: {
